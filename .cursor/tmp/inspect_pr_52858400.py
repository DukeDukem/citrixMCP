...
CASE = "6a6c76eb6156a1e66d9fa884"
MARKERS = ["RETXXXXXXX", "Rücksendeauftragsnummer", "router-retoure", "Seriennummer"]
...
with sync_playwright() as p:
    ...
    body = target.inner_text("body")[:2000]
    print("---PAGE---")
    for line in body.splitlines():
        if any(k in line for k in ["Fall", "52858400", "Renziehausen", "Liane"]):
            print(line[:220])
    ...
    print("GUTEN_TAG_COUNT", text.count("Guten Tag"))
