...
CASE = "6a6d8c47fc7ca7767974613e"
MARKERS = ["Drittanbietersperre", "Mehrwertdienst", "Mai bis August", "drittanbieter"]
...
with sync_playwright() as p:
    ...
    for line in body.splitlines():
        if any(k in line for k in ["Fall", "52920277", "Dmitrij", "Megel"]):
            print(line[:220])
