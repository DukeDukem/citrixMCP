...
CASE = "6a6ce9796156a1e66dd6b3d3"
MARKERS = ["Zugangsdaten", "Freischaltung", "089 78 79 79 400", "Vertrag verwalten"]
...
with sync_playwright() as p:
    ...
    for line in body.splitlines():
        if any(k in line for k in ["Fall", "52913685", "Küpfer", "Kupfer", "Ralf"]):
            print(line[:200])
