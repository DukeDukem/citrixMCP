...
t = (base / "temp_reply_52889766.txt").read_text(encoding="utf-8")
(base / "latest_re_reply.txt").write_text(t, encoding="utf-8")
(base / "latest_re_reply.json").write_text(
    json.dumps(
        {"case_id": "#52889766", "response_text": t, "saved_at": time.time()},
        ensure_ascii=False,
        indent=2,
    ),
    encoding="utf-8",
...
assert "6098547662" not in t
assert "mit 178 am Ende" in t
print("OK", len(t))
