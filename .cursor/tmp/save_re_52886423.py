...
Bitte prüfen Sie die Position zunächst in Mein o2 unter o2.de bzw. in der Mein o2 App unter Rechnung (Ihre genannte Rechnung endet auf 554). Dort sehen Sie die ausgewiesene SIM-Tausch-/Ersatz-SIM-Gebühr im Überblick.

Eine Ersatz-SIM kostet laut Tarif in der Regel 29,99 Euro; in Einzelfällen kann die Gebühr erlassen werden, wenn der Tausch aus Servicegründen nicht erforderlich war. Antworten Sie gerne kurz, ob die Gebühr auf genau dieser Rechnung noch offen ist und ob Sie die Ersatz-SIM selbst in Mein o2 bestellt haben oder sie Ihnen vom Service zugeschickt wurde. Für die Zuordnung nutzen wir Ihre Angabe mit 1912 am Ende.
