...
CASE = "6a6b93c66156a1e66dce40b1"
MARKERS = ["Sicherheitsmaßnahme", "IBAN", "Kundennummer", "Entschädigung", "Dirk Passin"]
...
with sync_playwright() as p:
    ...
    for line in body.splitlines():
        if any(k in line for k in ["Fall", "52789984", "Passin", "Dirk"]):
            print(line[:220])
