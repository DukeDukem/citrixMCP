...
def main() -> int:
    ...
    with sync_playwright() as p:
        ...
        # Prime Fall # watch: next sidebar click may trigger detection (LF / PR LF gate)
        try:
            _prime_script = REPO_ROOT / ".cursor" / "skills" / "sprinklr-email-automation" / "fall_watch_state.py"
            if _prime_script.exists():
                import subprocess
            ...
            print(f"[WARN] Could not prime Fall # watch: {e}")
