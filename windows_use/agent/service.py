...
class Agent:
    ...
    Args:
        ...
        target_window_title (str, optional): If set, screenshot captures only this window (e.g. Citrix session). Defaults to None.
    
    Returns:
        Agent
    '''
    def __init__(self,instructions:list[str]=[],additional_tools:list[BaseTool]=[],browser:Literal['edge','chrome','firefox']='edge', llm: BaseChatModel=None,consecutive_failures:int=3,max_steps:int=100,use_vision:bool=False,target_window_title:str|None=None):
        ...
        self.desktop = Desktop(target_window_title=target_window_title)
